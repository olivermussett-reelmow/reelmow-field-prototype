...
begin
 ...
 or (m.status='in_service' and p_target_status in ('ready','service_due','out_of_service'))
...
revoke all on function garage.transition_machine_status(uuid,garage.machine_status,text) from public;
